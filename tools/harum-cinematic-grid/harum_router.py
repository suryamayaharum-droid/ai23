...
if __name__=="__main__":
    ...
    ap.add_argument("--task",default="i2v",choices=[
        "edit","compile","grade","audio","subtitles","still_motion",
        "portrait_motion","microexpression","lipsync","i2v","atelier_motion",
        "object_motion","multi_reference","character_reference","audio_guided",
        "native_audio_video","interpolate","upscale"])
