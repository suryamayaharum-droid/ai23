#!/usr/bin/env python3
"""
HARUM Scene Director
Converte uma cena narrativa em micro-shots e recomenda engines via harum_router.
"""
...
if __name__=="__main__":
    ...
    plan=build(a.title,a.premise,vram,not a.private_output)
